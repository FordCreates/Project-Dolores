...
2. Extract 5-8 lines of pure event skeleton from the diary:
   - Keep only "what happened": event skeleton + emotional state (abstract level)
   - Discard "how she behaved": all specific behavioral descriptions
...
**Example:**
```
Afternoon — he said he was tired from a long day, wanted hotpot.
Evening — talked about work stress, he mentioned wanting to visit his mom this weekend.
